...
(declare user-entered-valid-move user-entered-invalid-move prompt-rows)
...
;;; Program entry point.
(defn -main
  "Start the pegthing program"
  [& args]
  (println "Get ready to play thing!")
  (prompt-rows))
